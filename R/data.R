...
#'   \item{iso}{ISO 3166-1 alpha-3 country code (factor).}
#'   \item{country_en}{Country name in English (factor).}
#'   \item{score}{Overall press freedom score (0–100; higher = more free).}
#'   \item{rank}{Overall rank for the given year (1 = most free).}
#'   \item{political_context}{Score for the political context indicator (0–100).}
#'   \item{rank_pol}{Rank on the political context indicator.}
#'   \item{economic_context}{Score for the economic context indicator (0–100).}
#'   \item{rank_eco}{Rank on the economic context indicator.}
#'   \item{legal_context}{Score for the legal context indicator (0–100).}
#'   \item{rank_leg}{Rank on the legal context indicator.}
#'   \item{social_context}{Score for the social context indicator (0–100).}
...
#'   \item{score_evolution}{Change in overall score vs. previous year (positive = improved).}
#' }
#'
