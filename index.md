...
- **[pbaumgartner-pressfreedom.share.connect.posit.cloud](https://pbaumgartner-pressfreedom.share.connect.posit.cloud/)**
  — for casual, interactive exploration. No install needed, full feature
  support, and stable long-term hosting.
...
Both run the exact same app code (`inst/app/app.R`), so the experience
...
package, which `pressfreedom` loads live at startup
([`pressfreedom.data::rwb_standardized`](https://www.peter-baumgartner.net/pressfreedom.data/reference/rwb_standardized.html))
rather than bundling. See its [pkgdown
site](https://www.peter-baumgartner.net/pressfreedom.data/index.html)
for the full data dictionary, cleaning pipeline, and known-issue
documentation. The dashboard’s own “About” tab covers scoring bands,
...
If you use this package or the underlying Press Freedom Index data,
please cite both:
...
[Open an issue on
GitHub](https://github.com/petzi53/pressfreedom/issues).

## License

MIT License. See
[LICENSE](https://www.peter-baumgartner.net/pressfreedom/LICENSE) for
details.

## Credits

The hex logo’s microphone icon is from Flaticon: [Microphone icons
created by Magnific -
Flaticon](https://www.flaticon.com/free-icons/microphone "microphone icons")

## Author

**Peter Baumgartner** · <petzi53@gmail.com> ·
[ORCID](https://orcid.org/0000-0003-4526-8791) ·
[GitHub](https://github.com/petzi53)

## Related

- [pressfreedom.data](https://github.com/petzi53/pressfreedom.data) —
  data acquisition and standardization
- [Reporters Without Borders (RSF)](https://rsf.org/) — original data
  source
